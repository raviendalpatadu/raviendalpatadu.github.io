  ...
  const projects = [
    {
      ...
      description: 'Zero-Knowledge Proof based framework to reduce organizational data liability in binary attestations. Implemented Circom circuits and Groth16 proof generation.',
      tags: ['Circom', 'Node.js', 'Cryptography', 'Research'],
      link: 'https://github.com/orgs/ZKPresearch/repositories',
      image: 'https://images.unsplash.com/photo-1639762681485-074b7f938ba0?q=80&w=2832&auto=format&fit=crop' // Abstract tech image
    },
    {
      title: 'Testify - Examination Platform',
      category: 'Full Stack Application',
      description: 'Secure examination platform used by tutors. Features automated grading and question generation using OpenAI API. Built with React and Spring Boot.',
      tags: ['React', 'Spring Boot', 'OpenAI API', 'MySQL'],
      link: 'https://github.com/orgs/Project-Testify/repositories',
      image: 'https://images.unsplash.com/photo-1606326608606-aa0b62935f2b?q=80&w=2940&auto=format&fit=crop' // Exam/Learning image
    },
    {
      title: 'TrackNBook',
      category: 'Web Application',
      description: 'Railway reservation and tracking system. Features front-end and back-end development for reservation tracking including MVC implementation.',
      tags: ['HTML', 'PHP', 'SCSS', 'JavaScript'],
      link: 'https://github.com/raviendalpatadu/trackNbook',
      image: 'https://images.unsplash.com/photo-1474487548417-781cb71495f3?q=80&w=2968&auto=format&fit=crop' // Train image
    },
    {
      title: 'Philldesk',
      category: 'Pharmacy Management',
      description: 'Online pharmacy management system for prescription management, billing, and inventory control.',
      tags: ['React', 'Spring Boot', 'Java'],
      link: 'https://github.com/raviendalpatadu/philldesk-frontend',
      image: 'https://images.unsplash.com/photo-1587854692152-cbe660dbde88?q=80&w=2969&auto=format&fit=crop' // Pharmacy/Medical image
    }
  ]
      ...
      <div className="container mx-auto max-w-6xl">
        ...
        >
            ...
            <p className="text-slate-400 max-w-2xl mx-auto">
                A selection of my recent work, ranging from research in cryptography to full-stack web applications.
            </p>
        </motion.div>
                    ...
                    <div className="p-8 flex-1 flex flex-col">
                        ...
                        <div className="flex flex-wrap gap-2 mb-8">
                            {project.tags.map(tag => (
                                <span key={tag} className="text-xs font-medium px-2.5 py-1 rounded-md bg-slate-700/50 text-slate-300 border border-slate-600">
                                    {tag}
                                </span>
                            ))}
                        </div>
        ...
        >
            ...
            >
                <FaGithub size={24} className="group-hover:text-cyan-400 transition-colors" />
