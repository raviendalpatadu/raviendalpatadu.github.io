...
import { BookOpen, Code, GraduationCap, Trophy, Briefcase, Award, Terminal, Target, Medal, Crown, Flag, ExternalLink } from 'lucide-react'
import { FaJava, FaPython, FaPhp, FaReact, FaGitAlt, FaDocker, FaSass } from 'react-icons/fa'
import { SiJavascript, SiTypescript, SiExpress, SiSpringboot, SiMysql, SiPostgresql, SiMongodb, SiPostman, SiLatex } from 'react-icons/si'
...
const About = () => {
  ...
  const education = [
    ...
    },
    {
      ...
      details: 'G.C.E. Advanced Level (2020) - 1A, 1C, 1S (Physical Science) | Ordinary Level - 6As, 3Bs',
      logo: '/imgs/stcb.png'
    }
  ]
  ...
  const experience = [
    {
        ...
        description: "Worked on the Asgardeo Admin Portal end-to-end. Designed frontend interfaces, built microservices for internal integrations, and implemented key features like tenant deletion and user management using React and Java.",
        logo: '/imgs/wso2.png'
    }
  ]
  ...
  const techAchievements = [
      {
          ...
          details: "2nd Place | Team 'HereForTheBytes'. Competing against over 50 universities. (Aug 2024)",
          icon: <Medal className="text-slate-300" />,
          image: "/imgs/cyberzee.jpg"
      },
      {
          title: "NetCom SLIIT CODEFEST 2023",
          details: "3rd Place | Team 'HereForTheBytes' secured 3rd place in the Netcom competition. (Jan 2024)",
          icon: <Award className="text-orange-400" />, // Bronzeish
          image: "/imgs/netcom.jpg"
      },
      {
          title: "CTF SLIIT CODEFEST 2023",
          details: "Merit Award | In the Capture The Flag (CTF) challenge. (Jan 2024)",
  ...
  return (
    <section id="about" className="py-24 px-4 md:px-8 bg-slate-950 relative overflow-hidden">
      ...
      <div className="container mx-auto max-w-5xl">
        ...
        >
            ...
            <p className="text-lg text-slate-400 leading-relaxed">
              Beyond academics, I am a proud member of the <span className="text-cyan-400 font-medium">Sri Lankan National Archery Team</span> (National Pool 2018-Present). 
              My diverse experiences in both academics and sports have instilled in me a strong sense of discipline, teamwork, and a commitment to excellence.
            </p>
        </motion.div>
                        ...
                        >
                            ...
                            <div className="flex flex-col sm:flex-row gap-4 items-start sm:items-center mb-4">
                                ...
                                <div>
                                    ...
                                    <p className="text-cyan-400 font-medium text-lg">{item.company} <span className="text-slate-500 text-base">| {item.period}</span></p>
                                </div>
                            </div>
                            
                            <p className="text-slate-400 leading-relaxed max-w-3xl">{item.description}</p>
                        </motion.div>
                    ))}
                </div>
            </motion.div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                    {education.map((item, index) => (
                        ...
                        >
                            ...
                            <div>
                                <h4 className="text-xl font-bold text-white mb-2 group-hover:text-indigo-400 transition-colors">{item.institution}</h4>
                                <p className="text-indigo-400 font-medium mb-1 text-sm">{item.title}</p>
                                <p className="text-slate-500 text-xs mb-4 uppercase tracking-wider">{item.year}</p>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
                    ...
                    <div>
                        <h4 className="text-xl font-bold text-slate-300 mb-6 flex items-center gap-2 pb-2 border-b border-slate-800">
                            <Target className="text-cyan-400" size={20} /> Sporting Achievements
                        </h4>
                                ...
                                >
                                    ...
                                    {item.image && (
                                        <div className="h-48 overflow-hidden relative border-b border-slate-800/50">
                                            ...
                                            <img src={item.image} alt={item.title} className="w-full h-full object-cover transform hover:scale-105 transition-transform duration-700" />
                                        </div>
                                    )}
                        ...
                        <div className="mt-8 text-center sm:text-left">
                            ...
                            >
                                View Athlete Profile <ExternalLink size={16} className="transform group-hover:-translate-y-0.5 group-hover:translate-x-0.5 transition-transform" />
                            </a>
                        </div>
                    </div>
                    ...
                    <div>
                        <h4 className="text-xl font-bold text-slate-300 mb-6 flex items-center gap-2 pb-2 border-b border-slate-800">
                            <Terminal className="text-purple-400" size={20} /> Tech Competitions
                        </h4>
                        <div className="space-y-6">
                    ...
                    {technologies.map((tech, i) => (
                        ...
                        >
                            ...
                            <div className="flex flex-wrap gap-2">
                                {tech.items.map((t, j) => (
                                    <div key={j} className="flex items-center gap-2 bg-slate-950 border border-slate-800 px-3 py-2 rounded-lg hover:border-emerald-500/50 transition-colors">
