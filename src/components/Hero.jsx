        ...
        >
            ...
            <div className="container mx-auto z-10 relative">
                <div className="flex flex-col-reverse lg:flex-row items-center justify-between gap-1 lg:gap-20">
                    ...
                    <div className="w-full lg:w-1/2 text-center lg:text-left lg:pt-0">
                        ...
                        >
                            ...
                            <h1 className="text-4xl md:text-7xl lg:text-8xl font-bold text-white mb-2 leading-tight tracking-tight">
                                Ravien <br />
                                <span className="text-transparent bg-clip-text bg-gradient-to-r from-cyan-400 via-blue-500 to-purple-600 animate-gradient-x">Dalpatadu</span>
                            </h1>

                            <div className="h-8 md:h-10 mb-2 text-lg md:text-2xl text-slate-400 font-mono">
                                <span>I build </span>
                                <span className="text-cyan-400 border-r-2 border-cyan-400 pr-1 animate-pulse">{currentRole}</span>
                            </div>
                            ...
                            <p className="text-slate-400 text-base md:text-lg leading-relaxed max-w-xl mx-auto lg:mx-0 mb-4">
                                Transforming ideas into reality through clean code and intuitive design. 
                                Undergraduate at UCSC crafting the future of the web.
                            </p>
                            ...
                            <div className="flex flex-col sm:flex-row items-center justify-center lg:justify-start gap-4 lg:gap-6">
                                ...
                                <div className="flex items-center gap-4">
                                    {[
                                        { icon: <Github size={20} />, href: "https://github.com/raviendalpatadu" },
                                        { icon: <Linkedin size={20} />, href: "https://www.linkedin.com/in/ravien-dalpatadu-8718b7223/" },
                                        { icon: <Mail size={20} />, href: "mailto:ravien.dalpatadu@gmail.com" }
                                    ].map((social, idx) => (
                                        <motion.a 
                                            key={idx}
                    ...
                    <motion.div 
                        className="w-1/3 lg:w-1/2 flex justify-center lg:justify-end relative mt-4 lg:mt-0"
                    >
                        <motion.div 
                        ...
                        >
                            ...
                            <div className="w-full h-full relative" style={{ transformStyle: "flat" }}>
                            
                                {/* 1. Base Layer (Natural) */}
                                <img 
                                    src="/imgs/ravein-hero.png" 
                                    alt="Ravien Natural" 
                                    className="absolute inset-0 w-full h-full object-contain pointer-events-none drop-shadow-2xl transition-all duration-500"
                                />
                                ...
                                <img 
                                    src="/imgs/ravein-hero.png" 
                                    alt="Ravien Mobile" 
                                    className="absolute inset-0 w-full h-full object-contain pointer-events-none lg:hidden opacity-100"
                                />
                            </div>
                        </motion.div>
                    </motion.div>
